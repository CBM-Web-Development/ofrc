		...
		<nav class="navbar navbar-expand-lg navbar-dark bg-dark primary-navbar">
			...
			<div class="container-fluid">
				...
				$left_navigation_args = array(
					...
					'menu_id'			=> '', 
					'container'			=> 'div', 
					'container_class'	=> 'collapse navbar-collapse justify-content-lg-center order-lg-0',
				...
				$right_navigation_args = array(
					...
					'menu_id'			=> '', 
					'container'			=> 'div', 
					'container_class'	=> 'collapse navbar-collapse justify-content-lg-center order-lg-3',
